...
function CoordinateMap(props) {
  ...
  function loadBuildingGeolocation(buildingEntity) {
    ...
    setBuildingObjects([...buildingObjects, buildBuildingObject(
      buildingEntity,
      {
        "resultCode": 191,
  ...
  function buildCoordinates(buildingGeo) {
    axios.get('http://128.195.53.189:4001/api/observation/search?obsTypeId=2&orderBy=id&direction=asc&orderBy2=id&direction2=asc&limit=25', {
      params: {
        payload: {
          entityId: 4
        }
